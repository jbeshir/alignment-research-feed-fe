    ...
    if (!data) {
        ...
        return (
            <div className='h-screen w-full flex flex-col space-y-4 pb-5'>
                ...
                <div className="font-medium text-black dark:text-white pl-5 pb-5">Made with love by <a href="https://beshir.org" className="text-emerald-500 hover:underline">JBeshir</a>.</div>
            </div>
        );
    }
}
