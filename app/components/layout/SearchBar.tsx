  ...
  return (
    <div className="relative w-full max-w-2xl mx-auto">
      ...
      <button
        ...
        className="absolute right-3 top-1/2 -translate-y-1/2 p-2 text-stone-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 transition-colors"
