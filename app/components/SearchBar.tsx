  ...
  return (
    <div className="relative w-full max-w-2xl mx-auto">
      <input
        ...
        className="w-full px-6 py-4 pr-14 text-base text-slate-900 bg-white border border-slate-200 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-brand-dark focus:border-transparent placeholder:text-slate-400"
